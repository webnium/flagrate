...
label:c.label,onSelect:this._createOnSelectHandler(this,c)})),c._button.insertTo(this._head);return this},_createOnSelectHandler:function(a,b){return function(c){a.select(b)}}};var A=e.Popover=function(a){a=a||{};this.target=a.target||null;var b=a.text||null,c=a.html||null,d=a.element||null;this.isShowing=!1;this.open=function(h){var k=window.event||{},m=this.target||k.target||document.documentElement;h instanceof Event&&(k=h);h instanceof HTMLElement&&(m=h);this.isShowing&&this.close();this.isShowing=
!0;var l=this._div=new f("div",{"class":e.className+" "+e.className+"-popover"});a.className&&l.addClassName(a.className);b&&l.updateText(b);c&&l.update(c);d&&l.update(d);l.style.opacity=0;l.insertTo(document.body);A._updatePosition(m,l);l.style.opacity=1;k.type&&"mouseover"===k.type&&(document.body.addEventListener("click",this.close),document.body.addEventListener("mouseout",this.close),document.body.addEventListener("mouseup",this.close),document.body.addEventListener("mousewheel",this.close));
var g=function(){!0===f.exists(m)?(A._updatePosition(m,l),this._positioningTimer=setTimeout(g,30)):this.close()}.bind(this);this._positioningTimer=setTimeout(g,30);h=function(a){a.stopPropagation();"mousewheel"===a.type&&a.preventDefault()};this._div.on("click",h);this._div.on("mouseup",h);this._div.on("mousewheel",h);return this}.bind(this);this.close=function(){clearTimeout(this._positioningTimer);document.body.removeEventListener("click",this.close);document.body.removeEventListener("mouseup",
...
this;b.onAfterStep()}a();return this}};var S=e.Notify=function(a){a=a||{};this.target=a.target||document.body;this.className=a.className||null;this.disableDesktopNotify=a.disableDesktopNotify||!1;this.disableFocusDetection=a.disableFocusDetection||!1;this.hAlign=a.hAlign||"right";this.vAlign=a.vAlign||"bottom";this.hMargin=a.hMargin||10;this.vMargin=a.vMargin||10;this.spacing=a.spacing||10;this.timeout=a.timeout||5;this.title=a.title||"Notify";this.notifies=[];!1===this.disableDesktopNotify&&(this.desktopNotifyType=
...
a.icon+")"}).insertTo(p));var q=function(){l=!1;p.style.opacity=0;null!==k&&k();setTimeout(function(){this.target.removeChild(p);this.notifies.splice(this.notifies.indexOf(p),1);this.positioner()}.bind(this),300)}.bind(this);c.on("click",function(a){a.stopPropagation();a.preventDefault();l&&q()},!1);p.style.display="none";p.style.position="fixed";p.style[this.hAlign]=b+"px";p.style[this.vAlign]=n+"px";if(null===h)p.on("click",function(a){q()});else p.style.cursor="pointer",p.on("click",function(a){a.stopPropagation();
a.preventDefault();h();q()});this.target.appendChild(p);p.style.display="block";setTimeout(function(){p.style.opacity=1},10);if(0!==m){var r=function(){l&&q()};g=setTimeout(r,1E3*m);p.on("mouseover",function(){clearTimeout(g);g=setTimeout(r,1E3*m)})}this.notifies.push(p);this.positioner();return this},createDesktopNotify:function(a){var b=a.title||this.title,c=a.message||a.body||a.content||a.text||null,d=a.onClick||null,e=a.onClose||null,f=void 0!==a.timeout?a.timeout:this.timeout,m=!0,l=null,g=this.desktopNotifyType;
if("w3c"===g){if("granted"!==window.Notification.permission)return!1;l=new window.Notification(b,{icon:a.icon,body:c})}if("webkit"===g){if(0!==window.webkitNotifications.checkPermission())return!1;l=window.webkitNotifications.createNotification("",b,c)}0!==f&&setTimeout(function(){m&&("w3c"===g?l.close():l.cancel())},1E3*f);null===d?l.addEventListener("click",function(a){"w3c"===g?l.close():l.cancel()}):l.addEventListener("click",function(a){d();"w3c"===g?l.close():l.cancel()});l.onclose=function(){m=
!1;null!==e&&e()};l.show&&l.show();return!0},positioner:function(){var a=this.target===document.body?window.innerHeight||document.body.clientHeight:this.target.offsetHeight,b=0,c=0,d,e;d=0;for(e=this.notifies.length;d<e;d++){var f=this.notifies[d],m=this.hMargin+c;f.style[this.hAlign]=(this.vMargin+b).toString(10)+"px";f.style[this.vAlign]=m.toString(10)+"px";c+=this.spacing+f.offsetHeight;c+f.offsetHeight+this.vMargin+this.spacing>=a&&(c=0,b+=this.spacing+f.offsetWidth)}}};var T=e.Modal=function(a){a=
a||{};this.target=a.target||document.body;this.id=a.id||null;this.className=a.className||null;this.title=a.title||"";this.subtitle=a.subtitle||a.description||"";this.text=a.text||"";this.html=a.html||"";this.element=a.element||a.content||null;this.href=a.href||"";this.buttons=a.buttons||[];this.sizing=a.sizing||"flex";this.onBeforeClose=a.onBeforeClose||r;this.onClose=a.onClose||r;this.onShow=a.onShow||r;this.disableCloseButton=a.disableCloseButton||!1;this.disableCloseByMask=a.disableCloseByMask||
!1;this.disableCloseByEsc=a.disableCloseByEsc||!1;0===this.buttons.length&&(this.buttons=[{label:"OK",color:"@primary",onSelect:this.close.bind(this),isFocused:!0}]);this._modal=new f("div");this._modal.on("click",function(a){a.stopPropagation()});!1===this.disableCloseButton&&(this._closeButton=(new q({label:"",onSelect:this.close.bind(this)})).insertTo(this._modal));this._header=(new f("hgroup")).insertTo(this._modal);(new f("h1")).insertText(this.title).insertTo(this._header);(new f("small")).insertText(this.subtitle).insertTo(this._header);
...
this._content.style.overflowX="auto",this._obi.style.top="10px",this._obi.style.bottom="10px",this._obi.style.height="",this._content.style.height=b-this._header.getHeight()-this._footer.getHeight()-20+"px",this._content.style.overflowY="auto");this.positioningTimer=setTimeout(h.bind(this),30)};this.positioningTimer=setTimeout(h.bind(this),0);this.buttons[0]&&this.buttons[0].button.focus();window.addEventListener("keydown",this._onKeydownHandler,!0);return this},show:function(){return this.open()},
render:function(){return this.open()},close:function(a){if(!1===this.visible())return this;this._base.removeClassName(e.className+"-modal-visible");a&&(a.stopPropagation(),a.preventDefault());if(!1===this.onBeforeClose(this,a))return this;clearTimeout(this.positioningTimer);this.closingTimer=setTimeout(function(){this._base.remove()}.bind(this),200);window.removeEventListener("keydown",this._onKeydownHandler,!0);this.onClose(this,a);return this},getButtonByKey:function(a){var b=null,c=this.buttons,
...
a.postProcessingOfRow||null;this._id="flagrate-grid-"+(++D.idCounter).toString(10);this._selectedRows=[];this.pagination&&(this.numberOfRowsPerPage=a.numberOfRowsPerPage||20,this.pagePosition=0);this.headless&&(this.disableResize=this.disableSort=!0);this.sortedByAsc=this.sortedByKey=null;return this._create()._requestRender()};e.createGrid=function(a){return new D(a)};D.idCounter=0;D.prototype={insertTo:function(a,b){return this.element.insertTo(a,b)&&this},select:function(a){var b,c,d;if(a instanceof
Array)b=a;else for(b=[],c=0,d=arguments.length;c<d;c++)b.push(arguments[c]);!1===this.multiSelect&&this.deselectAll();c=0;for(d=b.length;c<d;c++){var f=b[c];"number"===typeof f&&(f=this.rows[f]);f.isSelected=!0;if(!f._tr||!0!==f._tr.hasClassName(e.className+"-grid-row-selected")){this._selectedRows.push(f);f._tr&&f._tr.addClassName(e.className+"-grid-row-selected");f._checkbox&&f._checkbox.check();if(f.onSelect)f.onSelect(window.event,f);if(this.onSelect)this.onSelect(window.event,f)}}0!==this._selectedRows.length&&
this._checkbox&&this._checkbox.check();this.element.fire("change");return this},deselect:function(a){var b,c,d;if(a instanceof Array)b=a;else for(b=[],c=0,d=arguments.length;c<d;c++)b.push(arguments[c]);c=0;for(d=b.length;c<d;c++){var f=b[c];"number"===typeof f&&(f=this.rows[f]);f.isSelected=!1;if(!f._tr||!1!==f._tr.hasClassName(e.className+"-grid-row-selected")){this._selectedRows.splice(this._selectedRows.indexOf(f),1);f._tr&&f._tr.removeClassName(e.className+"-grid-row-selected");f._checkbox&&
f._checkbox.uncheck();if(f.onDeselect)f.onDeselect(window.event,f);if(this.onDeselect)this.onDeselect(window.event,f)}}0===this._selectedRows.length&&this._checkbox&&this._checkbox.uncheck();this.element.fire("change");return this},selectAll:function(){return this.select(this.rows)},deselectAll:function(){return this.deselect(this.rows)},getSelectedRows:function(){return this._selectedRows},sort:function(a,b){void 0===b&&(b=!0);this.rows.sort(function(b,c){var d=0,e=0;b.cell[a]&&(d=void 0!==b.cell[a].sortAlt?
...
(new w({onCheck:this.selectAll.bind(this),onUncheck:this.deselectAll.bind(this)})).insertTo((new f("th",{"class":e.className+"-grid-cell-checkbox"})).insertTo(a)));var b,c;b=0;for(c=this.cols.length;b<c;b++){var d=this.cols[b];d._id=this._id+"-col-"+b.toString(10);d._th=(new f("th")).insertTo(a);d.id&&d._th.writeAttribute("id",d.id);d.className&&d._th.writeAttribute("class",d.className);d.attribute&&d._th.writeAttribute(d.attribute);d.style&&d._th.setStyle(d.style);d._th.addClassName(d._id);var h=
...
d));!1!==this.disableSort||d.disableSort||(d._th.addClassName(e.className+"-grid-col-sortable"),d._th.onclick=this._createColOnClickHandler(this,d))}(new f("th",{"class":this._id+"-col-last"})).insertTo(a);this._style.insertText("."+this._id+"-col-last:after{right:0}");this.pagination&&(this.element.addClassName(e.className+"-grid-pagination"),this._pager=(new F({className:e.className+"-grid-pager",items:[{key:"rn",element:(new f("span")).insertText("-")},{key:"first",element:new q({className:e.className+
...
d);if(d.onDblClick||this.onDblClick)d._tr.ondblclick=this._createRowOnDblClickHandler(this,d);a&&!d._checkbox&&(d._checkbox=(new w({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new f("td",{"class":e.className+"-grid-cell-checkbox"})).insertTo(d._tr)));!0===d.isSelected&&this.select(d);for(c=0;c<q;c++){h=this.cols[c];k=void 0===d.cell[h.key]?d.cell[h.key]={}:d.cell[h.key];if("string"===typeof k||"number"===typeof k)k=d.cell[h.key]={text:k};k._td||(k._td=new f("td"));k._td.insertTo(d._tr);
k.id&&k._td.writeAttribute("id",k.id);k.className&&k._td.writeAttribute("class",k.className);k.attribute&&k._td.writeAttribute(k.attribute);k.style&&k._td.setStyle(k.style);h.align&&(k._td.style.textAlign=h.align);k._td.addClassName(h._id);k._div||(k._div=new f);k._div.insertTo(k._td);void 0!==k.text&&k._div.updateText(k.text);k.html&&k._div.update(k.html);k.element&&k._div.update(k.element);k.icon&&(k._div.addClassName(e.className+"-icon"),k._div.setStyle({backgroundImage:"url("+k.icon+")"}));k.onClick&&
(k._td.addClassName(e.className+"-grid-cell-clickable"),k._td.onclick=this._createCellOnClickHandler(this,k));k.onDblClick&&(k._td.ondblclick=this._createCellOnDblClickHandler(this,k));k.postProcess&&k.postProcess(k._td)}d._last||(d._last=new f("td",{"class":this._id+"-col-last"}));d._last.insertTo(d._tr);d.menuItems&&(d._last.addClassName(e.className+"-grid-cell-menu"),d._menu&&d._menu.remove(),d._menu=new E({target:d._tr,items:d.menuItems}),d._last.onclick=this._createLastRowOnClickHandler(this,
...
typeof a.createTextRange){var b=a.createTextRange();b.collapse(!1);b.select()}},0):a.focus());return this},_collectFieldRefs:function(a){a._refs=[];"undefined"!==typeof a.point&&(a.pointer=a.point,delete a.point);if(!a.key&&"string"!==typeof a.pointer)return this;var b,c,d,e,f,g,l;b=0;for(c=this.fields.length;b<c;b++)if(g=this.fields[b],a!==g&&g.depends&&0!==g.depends.length)for(d=0,e=g.depends.length;d<e;d++)if(g.depends[d]instanceof Array){l=!1;e=0;for(f=g.depends[d].length;e<f;e++){if(g.depends[d][e].key===
a.key){l=!0;break}"string"===typeof g.depends[d][e].point&&(g.depends[d][e].pointer=g.depends[d][e].point,delete g.depends[d][e].point);if("string"===typeof g.depends[d][e].pointer){if(g.depends[d][e].pointer===a.pointer){l=!0;break}if(g.depends[d][e].pointer==="/"+a.key){l=!0;break}}}l&&a._refs.push(g);break}else{if(g.depends[d].key===a.key){a._refs.push(g);break}"string"===typeof g.depends[d].point&&(g.depends[d].pointer=g.depends[d].point,delete g.depends[d].point);if("string"===typeof g.depends[d].pointer){if(g.depends[d].pointer===
a.pointer){a._refs.push(g);break}if(g.depends[d].pointer==="/"+a.key){a._refs.push(g);break}}}return this},_compareDepend:function(a){var b;if(a.key){var c=this.getField(a.key);if(null!==c){if(!a.op&&!a.tester&&void 0===a.val)return!0;!0===c._dependsIsOk&&(b=c.getVal())}}else if("string"===typeof a.pointer)try{b=u.get(this.getResult(),a.pointer)}catch(d){}else return!0;if("function"===typeof a.tester)return!!a.tester(b,a);if(a.op){if("==="===a.op&&a.val===b||"!=="===a.op&&a.val!==b||">="===a.op&&
a.val>=b||"<="===a.op&&a.val<=b||">"===a.op&&a.val>b||"<"===a.op&&a.val<b||"in"===a.op&&"undefined"!==typeof b[a.val])return!0}else if(a.val===b)return!0;return!1},_checkFieldDepends:function(a){var b=a.depends;if(!b||0===b.length)return a._dependsIsOk=!0;var c=!0,d,e,f,g,l,n;d=0;for(e=b.length;d<e;d++)if(l=b[d],l instanceof Array){n=!1;f=0;for(g=l.length;f<g;f++)if(!0===this._compareDepend(l[f])){n=!0;break}if(!1===n){c=!1;break}}else if(!1===this._compareDepend(l)){c=!1;break}return a._dependsIsOk=
c},_createField:function(a){a._dependsIsOk=!a.depends||0===a.depends.length;a._div=new f("div");a.id&&a._div.writeAttribute("id",a.id);a.className&&a._div.writeAttribute("class",a.className);a.attribute&&a._div.writeAttribute(a.attribute);a.style&&a._div.setStyle(a.style);!1===this.nolabel&&(a._label=(new f("label")).insertText(a.label||""),(new f("div",{"class":e.className+"-form-field-label"})).insert(a._label).insertTo(a._div),a.icon&&(a._label.addClassName(e.className+"-icon"),a._label.setStyle({backgroundImage:"url("+
