...
(this.element.addClassName(e.className+"-grid-pagination"),this._pager=(new E({className:e.className+"-grid-pager",items:[{key:"rn",element:(new f("span")).insertText("-")},{key:"first",element:new q({className:e.className+"-grid-pager-first",onSelect:function(){this.pagePosition=0;this._requestRender()}.bind(this)})},{key:"prev",element:new q({className:e.className+"-grid-pager-prev",onSelect:function(){--this.pagePosition;this._requestRender()}.bind(this)})},{key:"num",element:(new f("span",{"class":e.className+
...
parseInt(b._resizeHandle.style.left.replace("px",""),10)+a+"px"},g=function(c){c.preventDefault();document.body.removeEventListener("mousemove",f,!0);document.body.removeEventListener("mouseup",g,!0);c=c.clientX-e;c=b._th.getWidth()+c;c=b.width=0>c?0:c;a._style.updateText(a._style.innerHTML.replace(new RegExp("("+b._id+"{width:)([^}]*)}"),"$1"+c+"px}"));a._updateLayoutOfCols();a._updatePositionOfResizeHandles()};document.body.addEventListener("mousemove",f,!0);document.body.addEventListener("mouseup",
g,!0)}}};var g=e.Form=function(a){a=a||{};this.id=a.id||null;this.className=a.className||null;this.attribute=a.attribute||null;this.style=a.style||null;this.nolabel=a.nolabel||!1;this.vertical=a.vertical||!1;this.fields=[];this._create();a.fields&&0!==a.fields.length&&this.push(a.fields);return this};e.createForm=function(a){return new g(a)};g.idCounter=0;g.prototype={insertTo:function(a,b){return this.element.insertTo(a,b)&&this},getResult:function(){var a={},b,c,d;b=0;for(c=this.fields.length;b<
c;b++)d=this.fields[b],!d.key&&"string"!==typeof d.pointer||!0!==d._dependsIsOk||null!==d.pointer&&("string"===typeof d.pointer?t.set(a,d.pointer,d.getVal()):d.key&&(a[d.key]=d.getVal()));return a},validate:function(a){var b,c,d,e=[],f;b=0;for(c=this.fields.length;b<c;b++)d=this.fields[b],!0===d._dependsIsOk&&d.input&&d.input._type&&e.push(d);var g=!1,l=function(a){!1===a&&(g=!0);f()};f=function(){0===e.length?a&&a(!g):e.shift().validate(l)};f();return this},enable:function(){var a,b,c;a=0;for(b=
