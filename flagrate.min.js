...
d);a&&!d._checkbox&&(d._checkbox=(new s({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new e("td",{"class":f.className+"-grid-cell-checkbox"})).insertTo(d._tr)));!0===d.isSelected&&this.select(d);for(c=0;c<r;c++)k=this.cols[c],g=d.cell[k.key]||(d.cell[k.key]={}),g._td||(g._td=new e("td")),g._td.insertTo(d._tr),g.id&&g._td.writeAttribute("id",g.id),g.className&&g._td.writeAttribute("class",g.className),g.attribute&&g._td.writeAttribute(g.attribute),g.style&&g._td.setStyle(g.style),k.align&&
