...
this._createColOnClickHandler(this,d))}(new e("th",{"class":this._id+"-col-last"})).insertTo(a);this._style.insertText("."+this._id+"-col-last:after{margin-left:0}");this.element.onscroll=this._createOnScrollHandler(this);return this},_requestRender:function(){this._renderTimer&&clearTimeout(this._renderTimer);this._renderTimer=setTimeout(this._render.bind(this),0);return this},_render:function(){if(null!==this.onRender&&!1===this.onRender(this))return this;var a=!1===this.disableCheckbox&&!1===this.disableSelect&&
!0===this.multiSelect,b,c,d,k,g,h=this.rows.length,n=this.cols.length;this._tbody.update();for(b=0;b<h;b++){d=this.rows[b];d._tr||(d._tr=new e("tr"));d._tr.insertTo(this._tbody);d.id&&d._tr.writeAttribute("id",d.id);d.className&&d._tr.writeAttribute("class",d.className);d.attribute&&d._tr.writeAttribute(d.attribute);d.style&&d._tr.setStyle(d.style);if(d.onClick||this.onClick||!1===this.disableSelect)!1===this.disableSelect&&d._tr.addClassName(f.className+"-grid-row-selectable"),(d.onClick||this.onClick)&&
d._tr.addClassName(f.className+"-grid-row-clickable"),d._tr.onclick=this._createRowOnClickHandler(this,d);if(d.onDblClick||this.onDblClick)d._tr.ondblclick=this._createRowOnDblClickHandler(this,d);a&&!d._checkbox&&(d._checkbox=(new r({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new e("td",{"class":f.className+"-grid-cell-checkbox"})).insertTo(d._tr)));!0===d.isSelected&&this.select(d);for(c=0;c<n;c++)k=this.cols[c],g=d.cell[k.key]||(d.cell[k.key]={}),g._td||(g._td=new e("td")),g._td.insertTo(d._tr),
g.id&&g._td.writeAttribute("id",g.id),g.className&&g._td.writeAttribute("class",g.className),g.attribute&&g._td.writeAttribute(g.attribute),g.style&&g._td.setStyle(g.style),k.align&&(g._td.style.textAlign=k.align),g._td.addClassName(k._id),g._div||(g._div=new e),g._div.insertTo(g._td),g.text&&g._div.updateText(g.text),g.html&&g._div.update(g.html),g.element&&g._div.update(g.element),g.icon&&(g._div.addClassName(f.className+"-icon"),g._div.setStyle({backgroundImage:"url("+g.icon+")"})),g.onClick&&
(g._td.addClassName(f.className+"-grid-cell-clickable"),g._td.onclick=this._createCellOnClickHandler(this,g)),g.onDblClick&&(g._td.ondblclick=this._createCellOnDblClickHandler(this,g)),g.postProcess&&g.postProcess(g._td);d._last||(d._last=new e("td",{"class":this._id+"-col-last"}));d._last.insertTo(d._tr);d.menuItems&&(d._last.addClassName(f.className+"-grid-cell-menu"),d._menu&&d._menu.remove(),d._menu=new v({target:d._tr,items:d.menuItems}),d._last.onclick=this._createLastRowOnClickHandler(this,
d));d.postProcess&&d.postProcess(d._tr);this.postProcessOfRow&&this.postProcessOfRow(d._tr)}!1===this.disableResize&&(this._updateLayoutOfCols(),this._updatePositionOfResizeHandles());if(null!==this.onRendered)this.onRendered(this);return this},_updatePositionOfResizeHandles:function(){for(var a,b=0,c=this.cols.length;b<c;b++)a=this.cols[b],a._resizeHandle&&(a._resizeHandle.style.left=a._th.offsetLeft+a._th.getWidth()+"px");return this},_updateLayoutOfCols:function(){for(var a,b=0,c=this.cols.length;b<
c;b++)a=this.cols[b],a.width||(a.width=a._th.getWidth(),this._style.updateText(this._style.innerHTML.replace(RegExp("("+a._id+"{width:)([^}]*)}"),"$1"+a.width+"px}")));this.element.addClassName(f.className+"-grid-fixed");setTimeout(function(){this._style.updateText(this._style.innerHTML.replace(RegExp("("+this._id+"-col-last:after{margin-left:)([^}]*)}"),"$1"+(this.element.getWidth()-this.element.scrollWidth+this.element.scrollLeft)+"px!important}"))}.bind(this),0);return this},_createOnScrollHandler:function(a){return function(b){!1===
a.disableResize&&a._updateLayoutOfCols()}},_createColOnClickHandler:function(a,b){return function(c){a.sort(b.key,!b.isAsc)}},_createRowOnClickHandler:function(a,b){return function(c){if(b.onClick)b.onClick(c,b);if(a.onClick)a.onClick(c,b);!1===a.disableSelect&&(!0===b.isSelected?a.deselect(b):a.select(b))}},_createRowOnDblClickHandler:function(a,b){return function(c){if(b.onDblClick)b.onDblClick(c,b);if(a.onDblClick)a.onDblClick(c,b)}},_createCellOnClickHandler:function(a,b){return function(a){if(b.onClick)b.onClick(a,
