...
a;return this},isValid:function(){return this.regexp.test(this.getValue())}};var q=f.Checkbox=function(a){var b="flagrate-checkbox-"+(++q.idCounter).toString(10);a=a||{};this.onChange=a.onChange||null;this.onCheck=a.onCheck||null;this.onUncheck=a.onUncheck||null;var c=a.attribute||{};c.id=a.id||null;c["class"]=a.className||null;var d=(new e("label",c)).updateText(a.label);d.writeAttribute("for",b);m(d,this);d.addClassName(f.className+" "+f.className+"-checkbox");a.icon&&(d.addClassName(f.className+
"-icon"),d.setStyle({backgroundImage:"url("+a.icon+")"}));d._input=new e("input",{id:b,type:"checkbox"});d.insert({top:new e});d.insert({top:d._input});d._input.addEventListener("change",function(a){if(d.isChecked()){if(d.onCheck)d.onCheck(a)}else if(d.onUncheck)d.onUncheck(a);if(d.onChange)d.onChange(a)});a.isChecked&&d.check();a.isDisabled&&d.disable();return d};q.idCounter=0;q.prototype={disable:function(){this.addClassName(f.className+"-checkbox-disabled");this._input.writeAttribute("disabled",
...
d._tr.addClassName(f.className+"-grid-row-clickable"),d._tr.onclick=this._createRowOnClickHandler(this,d);if(d.onDblClick||this.onDblClick)d._tr.ondblclick=this._createRowOnDblClickHandler(this,d);a&&!d._checkbox&&(d._checkbox=(new q({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new e("td",{"class":f.className+"-grid-cell-checkbox"})).insertTo(d._tr)));!0===d.isSelected&&this.select(d);for(c=0;c<n;c++)k=this.cols[c],g=d.cell[k.key]||(d.cell[k.key]={}),g._td||(g._td=new e("td")),g._td.insertTo(d._tr),
