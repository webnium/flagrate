...
return this}};var z=e.Radio=function(a){var b="flagrate-radio-"+(++z.idCounter).toString(10);a=a||{};var c=a.attribute||{};c.id=a.id||null;c["class"]=a.className||null;var d=(new f("label",c)).updateText(a.label);d.writeAttribute("for",b);n(d,this);d.addClassName(e.className+" "+e.className+"-radio");a.icon&&(d.addClassName(e.className+"-icon"),d.setStyle({backgroundImage:"url("+a.icon+")"}));d._input=new f("input",{id:b,type:"radio",name:a.name});d.insert({top:new f});d.insert({top:d._input});d._input.on("change",
...
isChecked:function(){return!!this._input.checked},check:function(){this._input.checked=!0;return this},uncheck:function(){this._input.checked=!1;return this}};var C=e.Radios=function(a){a=a||{};this.items=a.items||[];var b="flagrate-radios-"+ ++z.idCounter;this.selectedIndex=a.selectedIndex||-1;var c=a.attribute||{};a.id&&(c.id=a.id);var d=new f("div",c),c=function(a){return function(){d.selectedIndex=a}},h,k;h=0;for(k=this.items.length;h<k;h++)"object"!==typeof this.items[h]&&(this.items[h]={label:"string"===
...
return this}};var K=e.Switch=function(a){a=a||{};var b=new q({id:a.id,className:a.className,attribute:a.attribute,style:a.style,isFocused:a.isFocused,isDisabled:a.isDisabled});n(b,this);b.onSelect=b.toggleSwitch.bind(b);b.addClassName(e.className+"-switch");b.dataset?b.dataset.flagrateSwitchStatus=a.isOn?"on":"off":b.writeAttribute("data-flagrate-switch-status",a.isOn?"on":"off");return b};e.createSwitch=function(a){return new K(a)};K.prototype={isOn:function(){return this.dataset?"on"===this.dataset.flagrateSwitchStatus:
"on"===this.readAttribute("data-flagrate-switch-status")},switchOn:function(){this.dataset?this.dataset.flagrateSwitchStatus="on":this.writeAttribute("data-flagrate-switch-status","on");return this.fire("on").fire("change")},switchOff:function(){this.dataset?this.dataset.flagrateSwitchStatus="off":this.writeAttribute("data-flagrate-switch-status","off");return this.fire("off").fire("change")},toggleSwitch:function(){return this.isOn()?this.switchOff():this.switchOn()}};var L=e.Progress=function(a){a=
a||{};this.value=a.value||0;this.max=a.max||100;var b=a.attribute||{};b.id=a.id||null;b["class"]=a.className||null;a=new f("div",b);n(a,this);a.addClassName(e.className+" "+e.className+"-progress");a._bar=(new f).insertTo(a);a._updateProgress();return a};e.createProgress=function(a){return new L(a)};L.prototype={getValue:function(){return this.value},setValue:function(a){if("number"!==typeof a)return this;this.value=Math.max(0,Math.min(this.max,a));this.fire("change");return this._updateProgress()},
...
d),document.body.addEventListener("MSPointerUp",e)):(document.body.addEventListener("mousemove",d),document.body.addEventListener("mouseup",e));this.setValue(Math.round(a/c));this.fire("slide")}};var P=e.Tab=function(a){a=a||{};this.tabs=a.tabs||[];this.bodyless=a.bodyless||!1;this.onSelect=a.onSelect||null;var b=a.attribute||[];b.id=a.id;b["class"]=e.className+" "+e.className+"-tab";a.fill&&(b["class"]+=" "+e.className+"-tab-fill");b=new f("div",b);n(b,this);a.className&&b.addClassName(a.className);
...
A._updatePosition(m,l);l.style.opacity=1;k.type&&"mouseover"===k.type&&(document.body.addEventListener("click",this.close),document.body.addEventListener("mouseout",this.close),document.body.addEventListener("mouseup",this.close),document.body.addEventListener("mousewheel",this.close));var g=function(){!0===f.exists(m)?(A._updatePosition(m,l),this._positioningTimer=setTimeout(g,30)):this.close()}.bind(this);this._positioningTimer=setTimeout(g,30);h=function(a){a.stopPropagation();"mousewheel"===a.type&&
...
1},10);if(0!==m){var t=function(){l&&q()};g=setTimeout(t,1E3*m);p.on("mouseover",function(){clearTimeout(g);g=setTimeout(t,1E3*m)})}this.notifies.push(p);this.positioner();return this},createDesktopNotify:function(a){var b=a.title||this.title,c=a.message||a.body||a.content||a.text||null,d=a.onClick||null,e=a.onClose||null,f=void 0!==a.timeout?a.timeout:this.timeout,m=!0,l=null,g=this.desktopNotifyType;if("w3c"===g){if("granted"!==window.Notification.permission)return!1;l=new window.Notification(b,
...
d))}(new f("th",{"class":this._id+"-col-last"})).insertTo(a);this._style.insertText("."+this._id+"-col-last:after{right:0}");this.pagination&&(this.element.addClassName(e.className+"-grid-pagination"),this._pager=(new F({className:e.className+"-grid-pager",items:[{key:"rn",element:(new f("span")).insertText("-")},{key:"first",element:new q({className:e.className+"-grid-pager-first",onSelect:function(){this.pagePosition=0;this._requestRender()}.bind(this)})},{key:"prev",element:new q({className:e.className+
