...
("number"===typeof c?a.input.max<c&&(d=!0):"string"===typeof c&&""!==c?a.input.max<parseInt(c,10)&&(d=!0):c instanceof Array&&a.input.max<c.length&&(d=!0));a.input.minLength&&a.input.minLength>(c.length||c.toString&&c.toString().length||0)&&"string"===typeof c&&""!==c&&(d=!0);a.input.maxLength&&a.input.maxLength<(c.length||c.toString&&c.toString().length||0)&&(d=!0);var g=[];a.input.validators.forEach(function(a){g.push(a)});var m,l=function(b,c){switch(b){case null:case "warning":h=!0;break;case !1:case "error":d=
