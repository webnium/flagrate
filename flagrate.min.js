...
this.disableSelect&&d._tr.addClassName(e.className+"-grid-row-selectable"),(d.onClick||this.onClick)&&d._tr.addClassName(e.className+"-grid-row-clickable"),d._tr.onclick=this._createRowOnClickHandler(this,d);if(d.onDblClick||this.onDblClick)d._tr.ondblclick=this._createRowOnDblClickHandler(this,d);a&&!d._checkbox&&(d._checkbox=(new v({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new f("td",{"class":e.className+"-grid-cell-checkbox"})).insertTo(d._tr)));!0===d.isSelected&&this.select(d);
for(c=0;c<q;c++)h=this.cols[c],k=void 0===d.cell[h.key]?d.cell[h.key]={}:d.cell[h.key],"string"===typeof k&&(k=d.cell[h.key]={text:k}),k._td||(k._td=new f("td")),k._td.insertTo(d._tr),k.id&&k._td.writeAttribute("id",k.id),k.className&&k._td.writeAttribute("class",k.className),k.attribute&&k._td.writeAttribute(k.attribute),k.style&&k._td.setStyle(k.style),h.align&&(k._td.style.textAlign=h.align),k._td.addClassName(h._id),k._div||(k._div=new f),k._div.insertTo(k._td),k.text&&k._div.updateText(k.text),
...
b);!1===a.disableSelect&&(!0===b.isSelected?a.deselect(b):a.select(b));b._checkbox&&b._checkbox.focus();return!1}}},_createRowOnDblClickHandler:function(a,b){return function(c){if(!1!==a.isEnabled()){if(b.onDblClick)b.onDblClick(c,b);if(a.onDblClick)a.onDblClick(c,b)}}},_createCellOnClickHandler:function(a,b){return function(c){if(!1!==a.isEnabled()&&b.onClick)b.onClick(c,b)}},_createCellOnDblClickHandler:function(a,b){return function(c){if(!1!==a.isEnabled()&&b.onDblClick)b.onDblClick(c,b)}},_createRowOnCheckHandler:function(a,
b){return function(c){!1===a.isEnabled()?!0===c.targetCheckbox.isChecked()?c.targetCheckbox.uncheck():c.targetCheckbox.check():!1===a.disableSelect&&(!0===this.isChecked()?a.select(b):a.deselect(b))}},_createLastRowOnClickHandler:function(a,b){return function(c){!1!==a.isEnabled()&&(c.stopPropagation(),b._menu&&b._menu.open(c))}},_createResizeHandleOnMousedownHandler:function(a,b){return function(c){c.preventDefault();var d=c.clientX,e=d,f=function(a){a.preventDefault();a=a.clientX-d;d+=a;b._resizeHandle.style.left=
parseInt(b._resizeHandle.style.left.replace("px",""),10)+a+"px"},g=function(c){c.preventDefault();document.removeEventListener("mousemove",f,!0);document.removeEventListener("mouseup",g,!0);c=c.clientX-e;c=b._th.getWidth()+c;c=b.width=0>c?0:c;a._style.updateText(a._style.innerHTML.replace(new RegExp("("+b._id+"{width:)([^}]*)}"),"$1"+c+"px}"));a._updateLayoutOfCols();a._updatePositionOfResizeHandles()};document.addEventListener("mousemove",f,!0);document.addEventListener("mouseup",g,!0)}}};var g=
e.Form=function(a){a=a||{};this.id=a.id||null;this.className=a.className||null;this.attribute=a.attribute||null;this.style=a.style||null;this.nolabel=a.nolabel||!1;this.vertical=a.vertical||!1;this.fields=[];this._create();a.fields&&0!==a.fields.length&&this.push(a.fields);return this};e.createForm=function(a){return new g(a)};g.idCounter=0;g.prototype={insertTo:function(a,b){return this.element.insertTo(a,b)&&this},getResult:function(){var a={},b,c,d;b=0;for(c=this.fields.length;b<c;b++)d=this.fields[b],
!d.key&&"string"!==typeof d.pointer||!0!==d._dependsIsOk||null!==d.pointer&&("string"===typeof d.pointer?u.set(a,d.pointer,d.getVal()):d.key&&(a[d.key]=d.getVal()));return a},validate:function(a){var b,c,d,e=[],f;b=0;for(c=this.fields.length;b<c;b++)d=this.fields[b],!0===d._dependsIsOk&&d.input&&d.input._type&&e.push(d);var g=!1,l=function(a){!1===a&&(g=!0);f()};f=function(){0===e.length?a&&a(!g):e.shift().validate(l)};f();return this},enable:function(){var a,b,c;a=0;for(b=this.fields.length;a<b;a++)c=
this.fields[a],c.input&&c.input._type&&c.input._type.enable.call(c.input);return this},disable:function(){var a,b,c;a=0;for(b=this.fields.length;a<b;a++)c=this.fields[a],c.input&&c.input._type&&c.input._type.disable.call(c.input);return this},getField:function(a){var b,c,d;b=0;for(c=this.fields.length;b<c;b++)if(d=this.fields[b],d.key&&d.key===a)return d;return null},push:function(a){var b,c;if(a instanceof Array)for(b=0,c=a.length;b<c;b++)this._createField(a[b]),this.fields.push(a[b]);else this._createField(a),
...
getVal:function(){return!0===this.element.multiple?this.element.getValues():this.element.getValue()},setVal:function(a){!1===this.element.multiple?a=[a]:this.element.deselectAll();var b,c,d,e;b=0;d=a.length;for(e=this.element.items.length;b<d;b++)for(c=0;c<e;c++)if(a[b]===this.element.items[c].value){this.element.select(c);break}},enable:g.inputType.text.enable,disable:g.inputType.text.disable};g.inputType.file={create:function(){return new f("input",{type:"file",accept:this.accept||(this.acceptTypes?
this.acceptTypes.join(","):void 0)})},getVal:function(){return this.element.files[0]},setVal:function(a){this.element.files[0]=a},enable:function(){this.element.writeAttribute("disabled",!1)},disable:function(){this.element.writeAttribute("disabled",!0)}};g.inputType.files={create:function(){return new f("input",{type:"file",accept:this.accept||(this.acceptTypes?this.acceptTypes.join(","):void 0),multiple:!0})},getVal:function(){return this.element.files},setVal:function(a){this.element.files=a},
enable:function(){this.element.writeAttribute("disabled",!1)},disable:function(){this.element.writeAttribute("disabled",!0)}}})();
