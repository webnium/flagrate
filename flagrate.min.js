...
b)}},_createCellOnDblClickHandler:function(a,b){return function(c){if(!1!==a.isEnabled()&&b.onDblClick)b.onDblClick(c,b)}},_createRowOnCheckHandler:function(a,b){return function(c){!1===a.isEnabled()?!0===c.targetCheckbox.isChecked()?c.targetCheckbox.uncheck():c.targetCheckbox.check():!1===a.disableSelect&&(!0===this.isChecked()?a.select(b):a.deselect(b))}},_createLastRowOnClickHandler:function(a,b){return function(c){!1!==a.isEnabled()&&(c.stopPropagation(),b._menu&&b._menu.open(c))}},_createResizeHandleOnMousedownHandler:function(a,
b){return function(c){c.preventDefault();var d=c.clientX,e=d,f=function(a){a.preventDefault();a=a.clientX-d;d+=a;b._resizeHandle.style.left=parseInt(b._resizeHandle.style.left.replace("px",""),10)+a+"px"},g=function(c){c.preventDefault();document.body.removeEventListener("mousemove",f,!0);document.body.removeEventListener("mouseup",g,!0);c=c.clientX-e;c=b._th.getWidth()+c;c=b.width=0>c?0:c;a._style.updateText(a._style.innerHTML.replace(new RegExp("("+b._id+"{width:)([^}]*)}"),"$1"+c+"px}"));a._updateLayoutOfCols();
a._updatePositionOfResizeHandles()};document.body.addEventListener("mousemove",f,!0);document.body.addEventListener("mouseup",g,!0)}}};var g=e.Form=function(a){a=a||{};this.id=a.id||null;this.className=a.className||null;this.attribute=a.attribute||null;this.style=a.style||null;this.nolabel=a.nolabel||!1;this.vertical=a.vertical||!1;this.fields=[];this._create();a.fields&&0!==a.fields.length&&this.push(a.fields);return this};e.createForm=function(a){return new g(a)};g.idCounter=0;g.prototype={insertTo:function(a,
b){return this.element.insertTo(a,b)&&this},getResult:function(){var a={},b,c,d;b=0;for(c=this.fields.length;b<c;b++)d=this.fields[b],!d.key&&"string"!==typeof d.pointer||!0!==d._dependsIsOk||null!==d.pointer&&("string"===typeof d.pointer?u.set(a,d.pointer,d.getVal()):d.key&&(a[d.key]=d.getVal()));return a},validate:function(a){var b,c,d,e=[],f;b=0;for(c=this.fields.length;b<c;b++)d=this.fields[b],!0===d._dependsIsOk&&d.input&&d.input._type&&e.push(d);var g=!1,l=function(a){!1===a&&(g=!0);f()};f=
function(){0===e.length?a&&a(!g):e.shift().validate(l)};f();return this},enable:function(){var a,b,c;a=0;for(b=this.fields.length;a<b;a++)c=this.fields[a],c.input&&c.input._type&&c.input._type.enable.call(c.input);return this},disable:function(){var a,b,c;a=0;for(b=this.fields.length;a<b;a++)c=this.fields[a],c.input&&c.input._type&&c.input._type.disable.call(c.input);return this},getField:function(a){var b,c,d;b=0;for(c=this.fields.length;b<c;b++)if(d=this.fields[b],d.key&&d.key===a)return d;return null},
push:function(a){var b,c;if(a instanceof Array)for(b=0,c=a.length;b<c;b++)this._createField(a[b]),this.fields.push(a[b]);else this._createField(a),this.fields.push(a);b=0;for(c=this.fields.length;b<c;b++)this._collectFieldRefs(this.fields[b]),this._checkFieldDepends(this.fields[b]);this._requestRender();return this.fields.length},splice:function(a,b,c){var d;b="undefined"===typeof b?this.fields.length-a:b;var e=this.fields.splice(a,b);b=0;for(d=e.length;b<d;b++)e[b]._div&&(e[b]._div.remove(),delete e[b]._div);
...
disable:g.inputType.text.disable};g.inputType.textarea={changeEvents:["change","keyup"],create:function(){return new G({placeholder:this.placeholder,icon:this.icon,attribute:{maxlength:this.maxLength}})},getVal:g.inputType.text.getVal,setVal:g.inputType.text.setVal,enable:g.inputType.text.enable,disable:g.inputType.text.disable};g.inputType.number={changeEvents:["change","keyup"],create:function(){return new w({placeholder:this.placeholder,icon:this.icon,attribute:{type:"number",inputmode:"numeric",
