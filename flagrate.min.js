...
this._pulldown.setIcon(this.items[a].icon)),this.fire("change")):this._grid.rows[a].isSelected||this._grid.select(a);return this},deselect:function(a){if(this.items.length<=a)return this;this.multiple?-1!==this.selectedIndexes.indexOf(a)&&this.selectedIndexes.splice(this.selectedIndexes.indexOf(a),1):this.selectedIndex=-1;if(this.isPulldown)this._pulldown.setLabel("-"),this._pulldown.setIcon(null),this.fire("change");else{var b;a=0;for(b=this.items.length;a<b;a++)!0===this._grid.rows[a].isSelected&&
this._grid.deselect(a)}return this},selectAll:function(){if(this.multiple){this._grid.selectAll();this.selectedIndexes=[];var a,b;a=0;for(b=this.items.length;a<b;a++)this.selectedIndexes.push(a)}return this},deselectAll:function(){this.multiple?(this._grid.deselectAll(),this.selectedIndexes=[]):this.deselect();return this},disable:function(){this.addClassName(e.className+"-disabled");this.isPulldown?this._pulldown.disable():this._grid.disable();return this},enable:function(){this.removeClassName(e.className+
...
return this},enable:function(){this.removeClassName(e.className+"-disabled");this._textinput.enable();this._button.enable();return this},isEnabled:function(){return!this.hasClassName(e.className+"-disabled")},getValue:function(){return this._textinput.value},setValue:function(a){this._textinput.value=a;return this},isValid:function(a){return this.regexp.test(this.getValue())}};var u=e.Checkbox=function(a){var b="flagrate-checkbox-"+(++u.idCounter).toString(10);a=a||{};this.onChange=a.onChange||null;
...
"-disabled")},isChecked:function(){return!!this._input.checked},check:function(){this._input.checked=!0;return this},uncheck:function(){this._input.checked=!1;return this}};var I=e.Checkboxes=function(a){a=a||{};this.items=a.items||[];var b=a.attribute||{};a.id&&(b.id=a.id);var b=new f("div",b),c,d;c=0;for(d=this.items.length;c<d;c++)"object"!==typeof this.items[c]&&(this.items[c]={label:"string"===typeof this.items[c]?this.items[c]:this.items[c].toString(10),value:this.items[c]}),this.items[c]._checkbox=
(new u({label:this.items[c].label,icon:this.items[c].icon,isChecked:this.items[c].isChecked,onCheck:this.items[c].onCheck,onUncheck:this.items[c].onUncheck})).insertTo(b);n(b,this);b.addClassName(e.className+" "+e.className+"-checkboxes");a.className&&b.addClassName(a.className);a.style&&b.setStyle(a.style);a.isDisabled&&b.disable();a.values&&b.setValues(a.values);return b};e.createCheckboxes=function(a){return new I(a)};I.prototype={select:function(a){this.items[a]&&this.items[a]._checkbox.check();
return this},deselect:function(a){this.items[a]&&this.items[a]._checkbox.uncheck();return this},getValues:function(){var a=[],b,c;b=0;for(c=this.items.length;b<c;b++)!0===this.items[b]._checkbox.isChecked()&&a.push(this.items[b].value);return a},addValue:function(a){var b,c;b=0;for(c=this.items.length;b<c;b++)if(this.items[b].value===a){this.select(b);break}return this},removeValue:function(a){var b,c;b=0;for(c=this.items.length;b<c;b++)if(this.items[b].value===a){this.deselect(b);break}return this},
setValues:function(a){var b,c;b=0;for(c=this.items.length;b<c;b++)-1===a.indexOf(this.items[b].value)?this.deselect(b):this.select(b);return this},selectAll:function(){var a,b;a=0;for(b=this.items.length;a<b;a++)this.select(a);return this},deselectAll:function(){return this.setValues([])},enable:function(){var a,b;a=0;for(b=this.items.length;a<b;a++)this.items[a]._checkbox.enable();return this},disable:function(){var a,b;a=0;for(b=this.items.length;a<b;a++)this.items[a]._checkbox.disable();return this}};
var y=e.Radio=function(a){var b="flagrate-radio-"+(++y.idCounter).toString(10);a=a||{};var c=a.attribute||{};c.id=a.id||null;c["class"]=a.className||null;var d=(new f("label",c)).updateText(a.label);d.writeAttribute("for",b);n(d,this);d.addClassName(e.className+" "+e.className+"-radio");a.icon&&(d.addClassName(e.className+"-icon"),d.setStyle({backgroundImage:"url("+a.icon+")"}));d._input=new f("input",{id:b,type:"radio",name:a.name});d.insert({top:new f});d.insert({top:d._input});d._input.on("change",
