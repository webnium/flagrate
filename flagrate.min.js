...
return a};e.insert=function(a,b){if("string"===typeof b||"number"===typeof b||b instanceof HTMLElement)b={bottom:b};var c,d,k;for(k in b)if(c=b[k],k=k.toLowerCase(),d=e._insertionTranslation[k],c instanceof HTMLElement)d(a,c);else{"string"!==typeof c&&(c=c.toString(10));var g=new e;g.innerHTML=c;"top"!==k&&"after"!==k||(void 0).reverse();for(c=0;c<g.childNodes.length;c++)d(a,g.childNodes[c])}return a};e.insertText=function(a,b){if("string"===typeof b||"number"===typeof b)b={bottom:b};var c,d,k;for(k in b)c=
...
g=this._removeButton.getHeight(),f=a.layerX,n=a.layerY;if(f>b-d-e&&f<b-d&&n>c-(c-g)/2-g&&n<c-(c-g)/2)return this._onRemoveHandler(a),this}this.onSelect(a)}},_onRemoveHandler:function(a){if(this.isEnabled()&&this.remove())this.onRemove(a)}};var s=f.Menu=function(a){a=a||{};a.items=a.items||[];this.onSelect=a.onSelect||function(){};var b=a.attribute||{};b.id=a.id;b["class"]=a.className;b=new e("div",b);m(b,this);b.addClassName(f.className+" "+f.className+"-menu");for(var c=0,d=a.items.length;c<d;c++)b.push(a.items[c]);
...
this.values=a.values||[];this.max=a.max||-1;this.tokenize=a.tokenize||y;this.onChange=a.onChange||function(){};var b=a.attribute||{};b.id=a.id||null;b["class"]=a.className||null;b=new e("div",b);m(b,this);b.addClassName(f.className+" "+f.className+"-tokenizer");a.icon&&(b.addClassName(f.className+"-icon"),b.setStyle({backgroundImage:"url("+a.icon+")"}));b._tokens=(new e("span")).insertTo(b);b._input=(new w({placeholder:a.placeholder})).insertTo(b);0!==b.values.length&&b._updateTokens();b.addEventListener("click",
...
a;return this},isValid:function(){return this.regexp.test(this.getValue())}};var r=f.Checkbox=function(a){var b="flagrate-checkbox-"+(++r.idCounter).toString(10);a=a||{};this.onChange=a.onChange||null;this.onCheck=a.onCheck||null;this.onUncheck=a.onUncheck||null;var c=a.attribute||{};c.id=a.id||null;c["class"]=a.className||null;var d=(new e("label",c)).updateText(a.label);d.writeAttribute("for",b);m(d,this);d.addClassName(f.className+" "+f.className+"-checkbox");a.icon&&(d.addClassName(f.className+
"-icon"),d.setStyle({backgroundImage:"url("+a.icon+")"}));d._input=new e("input",{id:b,type:"checkbox"});d.insert({top:new e});d.insert({top:d._input});d._input.addEventListener("change",function(a){if(d.isChecked()){if(d.onCheck)d.onCheck(a)}else if(d.onUncheck)d.onUncheck(a);if(d.onChange)d.onChange(a)});a.isChecked&&d.check();a.isDisabled&&d.disable();return d};r.idCounter=0;r.prototype={disable:function(){this.addClassName(f.className+"-checkbox-disabled");this._input.writeAttribute("disabled",
!0);return this},enable:function(){this.removeClassName(f.className+"-checkbox-disabled");this._input.writeAttribute("disabled",!1);return this},isEnabled:function(){return!this.hasClassName(f.className+"-checkbox-disabled")},isChecked:function(){return!!this._input.checked},check:function(){this._input.checked=!0;return this},uncheck:function(){this._input.checked=!1;return this}};var t=f.Radio=function(a){var b="flagrate-radio-"+(++t.idCounter).toString(10);a=a||{};var c=a.attribute||{};c.id=a.id||
null;c["class"]=a.className||null;c=(new e("label",c)).updateText(a.label);c.writeAttribute("for",b);m(c,this);c.addClassName(f.className+" "+f.className+"-radio");a.icon&&(c.addClassName(f.className+"-icon"),c.setStyle({backgroundImage:"url("+a.icon+")"}));c._input=new e("input",{id:b,type:"radio",name:a.name});c.insert({top:new e});c.insert({top:c._input});a.isChecked&&c.check();a.isDisabled&&c.disable();return c};t.idCounter=0;t.prototype={disable:function(){this.addClassName(f.className+"-radio-disabled");
this._input.writeAttribute("disabled",!0);return this},enable:function(){this.removeClassName(f.className+"-radio-disabled");this._input.writeAttribute("disabled",!1);return this},isEnabled:function(){return!this.hasClassName(f.className+"-radio-disabled")},isChecked:function(){return"checked"===this._input.readAttribute("checked")},check:function(){return this._input.writeAttribute("checked",!0)},uncheck:function(){return this._input.writeAttribute("checked",!1)}};var x=f.Progress=function(a){a=
a||{};this.value=a.value||0;this.max=a.max||100;var b=a.attribute||{};b.id=a.id||null;b["class"]=a.className||null;a=new e("div",b);m(a,this);a.addClassName(f.className+" "+f.className+"-progress");a._updateProgress();return a};x.prototype={getValue:function(){return this.value},setValue:function(a){if("number"!==typeof a)return this;this.value=Math.max(0,Math.min(this.max,a));return this._updateProgress()},_updateProgress:function(){var a=Math.max(0,Math.min(100,100*(this.value/this.max)));this.update((new e).setStyle({width:a+
"%"}));return this}};(f.Slider=function(a){a=a||{};var b=new x(a);m(b,this);b.addClassName(f.className+"-slider");b.addEventListener("mousedown",b._onPointerDownHandler.bind(b));b.addEventListener("touchstart",b._onPointerDownHandler.bind(b));b.addEventListener("MSPointerDown",b._onPointerDownHandler.bind(b));a.isDisabled&&b.disable();return b}).prototype={disable:function(){return this.addClassName(f.className+"-slider-disabled")},enable:function(){return this.removeClassName(f.className+"-slider-disabled")},
...
a.timeout:this.timeout,h=!0,n;a=this.hMargin;var m=this.vMargin,l=new e("div",{"class":this.className});l.addClassName(f.className+" "+f.className+"-notify");(new e("div",{"class":"title"})).insertText(b).insertTo(l);(new e("div",{"class":"text"})).insertText(c).insertTo(l);(new e("div",{"class":"close"})).update("&#xd7;").insertTo(l).addEventListener("click",function(a){a.stopPropagation();a.preventDefault();h&&q()},!1);l.style.display="none";l.style.position="fixed";l.style[this.hAlign]=a+"px";
l.style[this.vAlign]=m+"px";null===d?l.addEventListener("click",function(a){q()}):(l.style.cursor="pointer",l.addEventListener("click",function(a){a.stopPropagation();a.preventDefault();d();q()}));this.target.appendChild(l);l.style.display="block";setTimeout(function(){l.style.opacity=1},10);if(0!==g){var p=function(){h&&q()};n=setTimeout(p,1E3*g);l.addEventListener("mouseover",function(){clearTimeout(n);n=setTimeout(p,1E3*g)})}var q=function(){h=!1;l.style.opacity=0;null!==k&&k();setTimeout(function(){this.target.removeChild(l);
...
!0===this.multiSelect)&&(this._checkbox=(new r({onCheck:this.selectAll.bind(this),onUncheck:this.deselectAll.bind(this)})).insertTo((new e("th",{"class":f.className+"-grid-cell-checkbox"})).insertTo(a)));for(var b=0,c=this.cols.length;b<c;b++){var d=this.cols[b];d._id=this._id+"-col-"+b.toString(10);d._th=(new e("th")).insertTo(a);d.id&&d._th.writeAttribute("id",d.id);d.className&&d._th.writeAttribute("class",d.className);d.attribute&&d._th.writeAttribute(d.attribute);d.style&&d._th.setStyle(d.style);
...
0);return this},_render:function(){if(null!==this.onRender&&!1===this.onRender(this))return this;var a=!1===this.disableCheckbox&&!1===this.disableSelect&&!0===this.multiSelect,b,c,d,k,g,h=this.rows.length,n=this.cols.length;this._tbody.update();for(b=0;b<h;b++){d=this.rows[b];d._tr||(d._tr=new e("tr"));d._tr.insertTo(this._tbody);d.id&&d._tr.writeAttribute("id",d.id);d.className&&d._tr.writeAttribute("class",d.className);d.attribute&&d._tr.writeAttribute(d.attribute);d.style&&d._tr.setStyle(d.style);
if(d.onClick||this.onClick||!1===this.disableSelect)!1===this.disableSelect&&d._tr.addClassName(f.className+"-grid-row-selectable"),(d.onClick||this.onClick)&&d._tr.addClassName(f.className+"-grid-row-clickable"),d._tr.onclick=this._createRowOnClickHandler(this,d);if(d.onDblClick||this.onDblClick)d._tr.ondblclick=this._createRowOnDblClickHandler(this,d);a&&!d._checkbox&&(d._checkbox=(new r({onChange:this._createRowOnCheckHandler(this,d)})).insertTo((new e("td",{"class":f.className+"-grid-cell-checkbox"})).insertTo(d._tr)));
!0===d.isSelected&&this.select(d);for(c=0;c<n;c++)k=this.cols[c],g=d.cell[k.key]||(d.cell[k.key]={}),g._td||(g._td=new e("td")),g._td.insertTo(d._tr),g.id&&g._td.writeAttribute("id",g.id),g.className&&g._td.writeAttribute("class",g.className),g.attribute&&g._td.writeAttribute(g.attribute),g.style&&g._td.setStyle(g.style),k.align&&(g._td.style.textAlign=k.align),g._td.addClassName(k._id),g._div||(g._div=new e),g._div.insertTo(g._td),g.text&&g._div.updateText(g.text),g.html&&g._div.update(g.html),g.element&&
